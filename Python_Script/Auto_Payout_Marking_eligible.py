...
try:
    ...
    record_id = int(input("Enter the USER PTR ID of the record you want to update: "))

    # Get the new values from the user
    new_value1 = input("Enter here as t if you want to update this USER PTR ID to be auto_payout eligible: ")

    # Display the proposed changes
    print(f"Proposed changes:\nID: {record_id}\nauto_payout_eligible: {new_value1}")
